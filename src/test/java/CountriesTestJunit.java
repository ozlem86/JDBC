...
//        User connects to the database
        JdbcUtils.connectToDatabase("localhost","postgres","postgres","Tranbzon1461.");
...
//        Verify(dogrulamak) that the number of region ids greater than 1 is 17.
        int listSize = (int) regionIdList.stream().filter(t -> (int) t > 1).count(); //Lambda:)
